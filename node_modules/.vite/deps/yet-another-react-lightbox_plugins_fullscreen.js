...
// node_modules/yet-another-react-lightbox/dist/plugins/fullscreen/props.js
...
function FullscreenButton() {
  ...
  if (render.buttonFullscreen) {
    return React2.createElement(React2.Fragment, null, (_a = render.buttonFullscreen) === null || _a === void 0 ? void 0 : _a.call(render, { fullscreen, disabled, enter, exit }));
  }
  return React2.createElement(IconButton, { disabled, label: fullscreen ? "Exit Fullscreen" : "Enter Fullscreen", icon: fullscreen ? ExitFullscreenIcon : EnterFullscreenIcon, renderIcon: fullscreen ? render.iconExitFullscreen : render.iconEnterFullscreen, onClick: fullscreen ? exit : enter });
}

// node_modules/yet-another-react-lightbox/dist/plugins/fullscreen/Fullscreen.js
function Fullscreen({ augment, contains, addParent }) {
  augment(({ fullscreen, toolbar, ...restProps }) => ({
    toolbar: addToolbarButton(toolbar, PLUGIN_FULLSCREEN, React3.createElement(FullscreenButton, null)),
