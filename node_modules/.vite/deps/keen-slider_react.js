    ...
    function b(n2) {
      ...
      return t2 = { absToRel: L, add: C, details: null, distToIdx: E, idxToDist: I, init: function(t3) {
        ...
        !function() {
          ...
          i3 && (v2 = i3), r3 && (h2 = r3), y2 = v2 === -1 / 0 ? v2 : n2.track.idxToDist(v2 || 0, true, 0), x2 = h2 === k2 ? h2 : I(h2, true, 0), null === r3 && (b2 = h2), f(t4, "align", false) && h2 !== k2 && 0 === o2[L(h2)][2] && (x2 -= 1 - o2[L(h2)][0], h2 = E(x2 - T)), y2 = p(y2), x2 = p(x2);
